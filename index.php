...
$SQL="select prodId, prodName, prodPicNameSmall, prodDescribShort, prodPrice from Product";
...
while ($arrayp=mysqli_fetch_array($exeSQL))
{
  ...
  echo "<p class='padLeft-15'>".$arrayp['prodDescribShort']."</p>"; //display description
